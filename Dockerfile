...
RUN echo "dev-lang/php cli crypt ctype curl fileinfo filter gd hash iconv intl ipv6 json mhash opcache mysql pdo phar posix readline session simplexml sockets ssl tokenizer unicode xml xmlreader xmlwriter zip zlib" >> /etc/portage/package.use
